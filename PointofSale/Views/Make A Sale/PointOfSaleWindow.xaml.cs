...
namespace PointofSale.Views
{
    public partial class PointOfSaleWindow : Window
    {
        ...
        {
            base.OnClosed(e);
            // Restore the hidden MainWindow instead of building a new one.
        ...
        {
            Close(); // OnClosed calls MainWindow.Resume()
        }
        ...
        private void LogoutBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            Close(); // OnClosed calls MainWindow.Resume() showing the post-logout state
        }
